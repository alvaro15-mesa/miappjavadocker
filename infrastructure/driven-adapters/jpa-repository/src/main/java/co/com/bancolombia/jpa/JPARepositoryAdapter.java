...
@Repository
public class JPARepositoryAdapter extends AdapterOperations<Animales/* change for domain model */, AnimalEntities/* change for adapter model */, String, JPARepository>
